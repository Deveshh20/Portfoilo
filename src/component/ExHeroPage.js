...
// import './Navbar.css'
const ExHeroPage = (props) => {
  const { theme, setTheme } = props
  return (

    // Bio
    <div className='flex flex-col justify-center items-center lg:mt-14  h-full w-screen'>
      <p className='text-white dark:text-stone-900  lg:mt-8 max-[400px]:text-[25px] lg:text-7xl font-bold w-fit mb-10 '>Passion ignites the spark within.</p>
      ...
      <div className='mt-10 max-[400px]:w-[400px] w-[900px] flex flex-col mb-32 items-center justify-center'>
